...
################################################################
# This is a generated script based on design: MICRO
#
...
proc create_root_design { parentCell } {
  ...
  set gpio_io_o_1 [ create_bd_port -dir O -from 7 -to 0 gpio_io_o_1 ]
  set gpio_io_o_2 [ create_bd_port -dir O -from 0 -to 0 gpio_io_o_2 ]
  set gpio_io_o_3 [ create_bd_port -dir O -from 0 -to 0 gpio_io_o_3 ]
  set gpio_io_o_4 [ create_bd_port -dir O -from 0 -to 0 gpio_io_o_4 ]
  ...
  # Create instance: inverse_divisor_0, and set properties
  set inverse_divisor_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:inverse_divisor:1.0 inverse_divisor_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins inverse_divisor_0/s_axi_CTRL_BUS]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports gpio_io_o_1] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_ports gpio_io_o_2] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_ports gpio_io_o_3] [get_bd_pins axi_gpio_3/gpio_io_o]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_ports gpio_io_o_4] [get_bd_pins axi_gpio_4/gpio_io_o]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs inverse_divisor_0/s_axi_CTRL_BUS/Reg] SEG_inverse_divisor_0_Reg
